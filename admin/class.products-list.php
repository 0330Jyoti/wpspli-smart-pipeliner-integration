...
class Product_Listpl extends WP_List_Table {
	/** Class constructor */
	public function __construct() {
		parent::__construct( [
			'singular' => esc_html__( 'Order', 'wpspli-smart-pipeliner' ), //singular name of the listed records
			'plural'   => esc_html__( 'Orders', 'wpspli-smart-pipeliner' ), //plural name of the listed records
	...
	public function no_items() {
		echo esc_html__( 'No products avaliable.', 'wpspli-smart-pipeliner' );
	}
	...
	function get_columns() {
		$columns = [
			'ID'    => esc_html__( 'Product Id', 'wpspli-smart-pipeliner' ),
			'post_title'    => esc_html__( 'Product Name', 'wpspli-smart-pipeliner' ),
			'meta_value'    => esc_html__( 'Sku', 'wpspli-smart-pipeliner' ),
			'post_date'    => esc_html__( 'Create Time', 'wpspli-smart-pipeliner' ),
