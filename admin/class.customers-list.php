...
function usersFinalDatapl($users_data)
  {
    return $users_data['data'];
  }

class Customers_Listpl extends WP_List_Table{
    /** Class constructor */
    public function __construct(){
        parent::__construct(['singular'     => esc_html__('Customer', 'wpspli-smart-pipeliner') , //singular name of the listed records
        'plural'                            => esc_html__('Customers', 'wpspli-smart-pipeliner') , //plural name of the listed records
        'ajax'                              => true
    ...
    public function no_items(){
        echo esc_html__('No customers avaliable.', 'wpspli-smart-pipeliner');
    }
    ...
    function column_action($item){
        $action = '<form action="" method="post">                      
                        ...
                        <button class="button" name="smart_synch" value="pipeliner" type="submit">'.esc_html__('Sync', 'wpspli-smart-pipeliner').'</button>
                </form>';
        return $action;
    }
    ...
    function get_columns(){
        $columns = [
                'ID'                  => esc_html__('Id', 'wpspli-smart-pipeliner') , 
                'woocommerce_name'    => esc_html__('Name', 'wpspli-smart-pipeliner') , 
                'user_email'          => esc_html__('Email', 'wpspli-smart-pipeliner') , 
                'user_registered'     => esc_html__('Create Time', 'wpspli-smart-pipeliner') , 
                'action'              => esc_html__('Action', 'wpspli-smart-pipeliner') 
            ];
        return $columns;
    }
